...
HomeView = (function(_super) {
  ...
  HomeView.prototype.animateItemIn = function(item, index, fullPageTransition, cb) {
    var duration, fromParams, onComplete, toParams;
