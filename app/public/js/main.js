  ...
  PageTransitioner.prototype.out = function(cb) {
    this.$panes.each((function(_this) {
      return function(i, el) {
        ...
        params.transform = _this.activeConfig.prop;
        if (i === 0) {
          params.onComplete = function() {
            _this.hide();
            return typeof cb === "function" ? cb() : void 0;
