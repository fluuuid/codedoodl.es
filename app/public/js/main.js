...
HomeGridItem = (function(_super) {
  ...
  HomeGridItem.prototype.ITEM_MAX_OFFSET = 700;
  ...
  function HomeGridItem(model) {
    ...
    this.maxOffset = (_.random(this.ITEM_MIN_OFFSET, this.ITEM_MAX_OFFSET)) / 10;
  ...
  HomeView.prototype.checkItemsForVisibility = function() {
    ...
    for (i = _i = 0, _len = _ref.length; _i < _len; i = ++_i) {
      ...
      item.$el.css({
        ...
        'opacity': position.visibility > 0 ? position.visibility + 0.3 : 0,
